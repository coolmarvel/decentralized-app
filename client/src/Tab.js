...
class Tabs extends React.Component {
  ...
  async getArtistSongs(name) {
    const artistSongs = await this.state.simpcontract.methods
      .getArtistSongs(name)
      .call();
  ...
  async likeThisSong() {
    this.state.simpcontract.methods
      .likeSong(this.state.artistPlaying, this.state.songPlaying)
  ...
  render() {
    return (
      ...
      <div
        className="container"
        style={{
          backgroundImage: "url(./insideBG.png)",
        ...
        <div className="content-tabs">
          ...
          >
            ...
            >
              <div className="section1">
                ...
                <button type="submit" hidden="" value="Use Address">
                  Use Address
                </button>
              </div>
            </form>
              ...
              <div className="form-section-2">
                <form
                  onSubmit={(event) => {
                    ...
                    const SongProducer = new FormData(event.target).get(
                      "SongProducer"
                    );
                    const SongArtist = new FormData(event.target).get(
                      "SongArtist"
                    );
                    const SongDate = new FormData(event.target).get("SongDate");
                    const Genre = new FormData(event.target).get("Genre");
                    const AlbumName = new FormData(event.target).get(
                      "AlbumName"
                    );
                ...
                >
                  ...
                  <button className="sec2-submit" type="submit">
                    {" "}
                    Add to Blockchain{" "}
                  </button>
                </form>
          ...
          >
            <div className="section4">
              ...
              >
                <input
                  ...
                  required
                ></input>
                <button type="submit" hidden="" value="Play Music">
                  Play Music
                </button>
              </form>
              <br></br>
            ...
            <div className="likebutton">
              <button onClick={this.likeThisSong.bind(this)}>
                Like this Song
              </button>
            </div>
          </div>
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      required
                    ></input>
                    <button type="submit" hidden="" value="Get top Songs">
                      Get top Songs
                    </button>
                  </form>
                  <p>
                    {" "}
                    {this.state.topSongs.map((name) => (
                      <div className="listSA">
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      required
                    ></input>
                    <button type="submit" hidden="" value="Get top Artists">
                      Get top Artists
                    </button>
                  </form>
                  <p>
                    {" "}
                    {this.state.topArtists.map((name) => (
                      <div>
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      required
                    ></input>
                    <button type="submit" hidden="" value="Get top Listeners">
                      Get top Listeners
                    </button>
                  </form>
                  <p>
                    {" "}
                    {this.state.topListeners.map((name) => (
                      <div>
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      required
                    ></input>
                    <button type="submit" hidden="" value="Get Genre Songs">
                      Get Genre Songs
                    </button>
                  </form>
                  <br></br>
                  ...
                  <p>
                    ...
                    {Object.keys(this.state.genreInfo).map((keyName, i) => (
                      <li key={i}>
                        <span>
                          Song Name: {this.state.genreInfo[keyName][0]}
                        </span>
                      </li>
                    ))}
                  </p>
